...
describe("panel theme", () => {
  ...
  it("returns refined dark theme tokens for the panel", () => {
    ...
    expect(vars["--panel-swatch-chip-border"]).toBe("rgba(212, 228, 244, 0.18)")
    expect(vars["--panel-swatch-dot-ring"]).toBe("rgba(212, 228, 244, 0.72)")
    expect(vars["--panel-swatch-dot-shadow"]).toBe("0 0 0 1px rgba(7, 12, 18, 0.42)")
  ...
  it("returns warm light theme tokens for the panel", () => {
    ...
    expect(vars["--panel-swatch-chip-border"]).toBe("rgba(111, 82, 48, 0.18)")
    expect(vars["--panel-swatch-dot-ring"]).toBe("rgba(111, 82, 48, 0.44)")
    expect(vars["--panel-swatch-dot-shadow"]).toBe("0 0 0 1px rgba(255, 250, 242, 0.9)")
