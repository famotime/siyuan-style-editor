...
export function createStyleEditorThemeVars(appearance: PanelThemeAppearance): Record<string, string> {
  if (appearance === "dark") {
    return {
      ...
      "--style-editor-table-header-bg": "#1e293b",
      "--style-editor-table-header-color": "#f8fafc",
      "--style-editor-table-border": "rgba(255, 255, 255, 0.08)",
      "--style-editor-table-row-odd": "rgba(255, 255, 255, 0.06)",
      "--style-editor-table-row-even": "transparent",
      "--style-editor-table-text": "#cbd5e1",
  ...
  return {
    ...
    "--style-editor-table-header-bg": "#f1f5f9",
    "--style-editor-table-header-color": "#1e293b",
    "--style-editor-table-border": "rgba(0, 0, 0, 0.08)",
    "--style-editor-table-row-odd": "rgba(15, 23, 42, 0.05)",
    "--style-editor-table-row-even": "transparent",
    "--style-editor-table-text": "#334155",
